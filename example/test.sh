...
python vef_clf.py --happy ./data/NA12878_chr11.snp.vcf.gz.happy.vcf.gz \
                  ...
                  --kind ${kind}
# Apply the model
python vef_apl.py --clf_file ./data/NA12878_chr11.snp.vcf.gz.vef_snp_${kind}.n_150.clf \
...
python vef_clf.py --happy ./data/NA12878_chr11.indel.vcf.gz.happy.vcf.gz \
                  ...
                  --kind ${kind}
#  Apply the model
python vef_apl.py --clf_file ./data/NA12878_chr11.indel.vcf.gz.vef_indel_${kind}.n_150.clf \
